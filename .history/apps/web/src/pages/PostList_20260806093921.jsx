...
export default function PostList() {
  useEffect(() => {
    fetch(`http://localhost:4100/posts`)
      ...
      .then((data) => {
        SVGTextPositioningElement(data);
      });
  }, [post]);
  return (
    <>
          ...
          <ul className="post-list">
              ...
              <div className="post-item-body">
                <div className="post-item-head">
                  ...
                  <h2 className="post-item-title">
                    <span>공지사항 먼저 읽고 미션 시작해주세요</span>
                  </h2>
                </div>
            ...
            <li className="post-item is-notice">
              ...
              <div className="post-item-side">
                <span className="reply-count has-replies">
                  <i className="pi pi-comment" aria-hidden="true" />
                  <span className="sr-only">댓글 </span>3
                </span>
              </div>
            </li>
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>게시판 미션 진행 중 막히는 부분 공유합니다</span>
                  </h2>
                </div>
                <div className="post-item-meta">
              ...
              <div className="post-item-side">
                <span className="reply-count has-replies">
                  <i className="pi pi-comment" aria-hidden="true" />
                  <span className="sr-only">댓글 </span>2
                </span>
              </div>
            </li>
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>페이지네이션 쿼리는 어떻게 넘기시나요?</span>
                  </h2>
                </div>
                <div className="post-item-meta">
              ...
              <div className="post-item-side">
                <span className="reply-count has-replies">
                  <i className="pi pi-comment" aria-hidden="true" />
                  <span className="sr-only">댓글 </span>5
                </span>
              </div>
            </li>
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>테이블에 정렬 붙이는 방법 정리했습니다</span>
                  </h2>
                </div>
                <div className="post-item-meta">
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>상세 화면에서 새로고침하면 내용이 사라져요</span>
                  </h2>
                </div>
                <div className="post-item-meta">
              ...
              <div className="post-item-side">
                <span className="reply-count has-replies">
                  <i className="pi pi-comment" aria-hidden="true" />
                  <span className="sr-only">댓글 </span>1
                </span>
              </div>
            </li>
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>작성 폼 유효성 검사 어디까지 하셨어요?</span>
                  </h2>
                </div>
                <div className="post-item-meta">
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>json-server 응답 구조 정리해봤습니다</span>
                  </h2>
                </div>
                <div className="post-item-meta">
                  <span className="post-author">작성자1</span>
              ...
              <div className="post-item-side">
                <span className="reply-count has-replies">
                  <i className="pi pi-comment" aria-hidden="true" />
                  <span className="sr-only">댓글 </span>4
                </span>
              </div>
            </li>
            ...
            <li className="post-item">
              <div className="post-item-body">
                <div className="post-item-head">
                  <h2 className="post-item-title">
                    <span>모바일에서 목록이 잘리는 현상 해결했습니다</span>
                  </h2>
                </div>
                <div className="post-item-meta">
                  <span className="post-author">작성자5</span>
